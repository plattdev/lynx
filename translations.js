const translations = {
  es: {
    ...
    "subtitle": "Un viaje visual a través de los datos que salvaron al felino más amenazado del planeta.<br>Haz scroll para descubrir la historia.",
  ...
  en: {
    ...
    "subtitle": "A visual journey through the data that saved the most endangered feline on the planet.<br>Scroll to discover the story.",
